<div class="headers">
    ...
    <header class="salmon tablet-header">
        <a href="<?php echo site_url()?>/index.php" class="logo-link"><img src="dist/images/preeti-img/background-elements/red-happy-sunshine-desktop-logo.png" alt="" class="desktop-logo"></a>
            ...
            <li class="menu-item-desktop">
                <a href="<?php echo site_url()?>/profile.php" class="desktop-link">
                    <svg viewbox="0 0 24 26.67" class="profile-icon">
                        <defs><style>.profile-svg-tablet{fill:#FFFBF4;stroke:#F2764F;stroke-width:.4px;}</style></defs>
