<div class="headers">
    <header class="mobile-header">
        <img src="dist/images/preeti-img/background-elements/cloud-header-red.png" alt="cloud header" class="cloud-header">
            <div class="top-nav">
                <a href="empty.html" class="cart-button">
                    <svg class="cart-icon shopping-bag" viewbox="0 0 34.96 39.96"><defs>
    ...
    <header class="salmon tablet-header">
        <a href="https://camkelly.net/idm216/final/" class="logo-link"><img src="dist/images/preeti-img/background-elements/red-happy-sunshine-desktop-logo.png" alt="" class="desktop-logo"></a>
        <ul class="desktop-menu">
            <li class="menu-item-desktop">
                    <a href="" class="desktop-link">
                        <svg viewbox="0 0 21.33 26.67" class="menu-icon">
                            <defs><style>.menu-svg-tablet{fill:#361e10;stroke:#F2764F;stroke-width:.4px;}</style></defs>
            ...
            <li class="salmon menu-item-desktop">
                <a href="" class="desktop-link">
            ...
            <li class="menu-item-desktop">
                <a href="" class="desktop-link">
                    <svg viewbox="0 0 24 26.67" class="profile-icon">
                        <defs><style>.profile-svg-tablet{fill:#361e10;stroke:#F2764F;stroke-width:.4px;}</style></defs>
    ...
    <header class="salmon desktop-header">
        <a href="https://camkelly.net/idm216/final/" class="logo-link"><img src="dist/images/preeti-img/background-elements/red-happy-sunshine-desktop-logo.png" alt="" class="desktop-logo"></a>
        <ul class="desktop-menu">
            <li class="menu-item-desktop">
                    <a href="" class="desktop-link"><h3 class="desktop-menu-link-item">MENU</h3></a>
            </li>
            <li class="menu-item-desktop">
                <a href="" class="desktop-link"><h3 class="desktop-menu-link-item">REWARDS</h3></a>
            </li>
            <li class="menu-item-desktop">
                <a href="" class="desktop-link"><h3 class="desktop-menu-link-item">PROFILE</h3></a>
            </li>
            <li class="menu-item-desktop">
                <a href="" class="desktop-link">
                    <svg class="desktop-cart-icon shopping-bag" viewbox="0 0 34.96 39.96"><defs>
