<div class="headers">
    <header class="mobile-header">
        <img src="dist/images/preeti-img/background-elements/cloud-header-orange.png" alt="cloud header" class="cloud-header">
            <div class="top-nav">
    ...
    <header class="tangerine tablet-header">
        <a href="https://camkelly.net/idm216/final/" class="logo-link"><img src="dist/images/preeti-img/background-elements/orange-happy-sunshine-desktop-logo.png" alt="" class="desktop-logo"></a>
        <ul class="desktop-menu">
            <li class="menu-item-desktop">
                    <a href="" class="desktop-link">
                        <svg viewbox="0 0 21.33 26.67" class="menu-icon">
                            <defs><style>.menu-svg-tablet{fill:#361e10;stroke:#FCA05B;stroke-width:.4px;}</style></defs>
            ...
            <li class="menu-item-desktop">
                <a href="" class="desktop-link">
                    <svg viewbox="0 0 24 26.67" class="profile-icon">
                        <defs><style>.profile-svg-tablet{fill:#361e10;stroke:#FCA05B;stroke-width:.4px;}</style></defs>
    ...
    <header class="tangerine desktop-header">
        <a href="https://camkelly.net/idm216/final/" class="logo-link"><img src="dist/images/preeti-img/background-elements/orange-happy-sunshine-desktop-logo.png" alt="" class="desktop-logo"></a>
        <ul class="desktop-menu">
            <li class="menu-item-desktop">
