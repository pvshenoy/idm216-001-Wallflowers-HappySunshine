<div class="headers">
    ...
    <header class="tangerine tablet-header">
        <a href="<?php echo site_url()?>/index.php" class="logo-link"><img src="dist/images/preeti-img/background-elements/orange-happy-sunshine-desktop-logo.png" alt="" class="desktop-logo"></a>
