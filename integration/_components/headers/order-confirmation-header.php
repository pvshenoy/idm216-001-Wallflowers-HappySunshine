...
<div class="headers">
    <header class="mobile-header">
        <img src="dist/images/preeti-img/background-elements/cloud-header.png" alt="cloud header" class="cloud-header">
            <div class="top-nav-inner-page">
                <a href="<?php echo site_url()?>/index.php" class="back-button">
                    <svg class="x-icon" viewbox="0 0 26.62 26.62">
                        <defs><style>.cls-1{fill:none;stroke:#361e10;stroke-linecap:round;stroke-linejoin:round;stroke-width:2.62px;}</style></defs>
                        <path class="cls-1" d="m25.31,1.31L1.31,25.31"/><path class="cls-1" d="m1.31,1.31l24,24"/>
                    </svg>
                </a>
            </div>
